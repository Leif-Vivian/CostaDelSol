...
function user_setup()
	...
	-- Custom binds for cycling modes
...
function init_gear_sets()
	...
	sets.midcast.RA                           = set_combine(sets.precast.RA,{neck="Ranger's necklace",body="Kyudogi +1",hands="Crimson finger gauntlets",waist="Scout's belt",legs="Enkidu's subligar",feet="Scout's socks"})
	...
	sets.precast.WS.HNM                       = set_combine(sets.precast.WS,{ring1="Merman's ring",back="Mamool Ja mantle",waist="Buccaneer's belt"})
	
	-- bow specific ws
	sets.precast.WS['Sidewinder']             = {head="Maat's cap"      ,neck="Breeze gorget" ,ear1="Drone earring" 
												,body="Kirin's osode"   ,hands="Seiryu's kote",ring1="Rajas ring"   ,ring2="Blobnag ring"
												,back="Amemet mantle +1",waist="Scout's belt" ,legs="Oily trousers" ,feet="Hachiryu sune-ate"}
	sets.precast.WS['Sidewinder'].HNM         = set_combine(sets.precast.WS['Sidewinder'],{ring1="Merman's ring",back="Mamool Ja mantle",waist="Buccaneer's belt"})
	
	sets.precast.WS['Jishnu\'s Radiance']     = set_combine(sets.precast.WS['Sidewinder'],{neck="Flame gorget"})
	sets.precast.WS['Jishnu\'s Radiance'].HNM = set_combine(sets.precast.WS['Jishnu\'s Radiance'],{ring1="Merman's ring",back="Mamool Ja mantle",waist="Buccaneer's belt"})
	...
	sets.precast.WS['Slug Shot']              = {head="Maat's cap"      ,neck="Breeze gorget" ,ear1="Drone earring"
												,body="Kirin's osode"   ,hands="Seiryu's kote",ring1="Rajas ring"  ,ring2="Blobnag ring"
												,back="Amemet mantle +1",waist="Scout's belt" ,legs="Oily trousers",feet="Hachiryu sune-ate"}
	sets.precast.WS['Slug Shot'].HNM          = set_combine(sets.precast.WS['Slug Shot'],{waist="Buccaneer's belt"})
	...
	sets.precast.WS['Coronach'].HNM           = set_combine(sets.precast.WS['Coronach'],{back="Amemet mantle +1",waist="Buccaneer's belt"})
